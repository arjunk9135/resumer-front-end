        ...
        <div className="flex items-center gap-4">
          ...
          <Select value={sortType} onValueChange={setSortType}>
            ...
            <SelectContent className="bg-white/90 dark:bg-gray-800 backdrop-blur-sm border border-gray-200 dark:border-gray-700 shadow-lg rounded-lg overflow-hidden">
              <SelectItem value="match" className="hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                Match Score
              </SelectItem>
              <SelectItem value="experience" className="hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                Experience
              </SelectItem>
              <SelectItem value="education" className="hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                Education
              </SelectItem>
              <SelectItem value="name" className="hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                Name
              </SelectItem>
            </SelectContent>
          </Select>
